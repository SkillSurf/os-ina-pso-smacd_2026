...
"""
    ...
    circuit.X('X1', 'FDDA_CMFB', 'V_B2', 'VDD', circuit.gnd, 'V_OP', 'V_B4', 'V_B3', 'V_B1', 'V_PP', 'V_PN', 'V_NP', 'V_NN', 'V_OP', 'V_CM', 'V_ON')
...
"""
    ...
    circuit.X('X1', 'FDDA_CMFB', 'V_B2', 'VDD', circuit.gnd, 'V_OP', 'V_B4', 'V_B3', 'V_B1', 'V_PP', 'V_OP', 'V_NP', 'V_ON', 'V_OP', 'V_CM', 'V_ON')
    circuit.V('VB1', 'V_B1', circuit.gnd, 0.7056@u_V)
    circuit.V('VB2', 'V_B2', circuit.gnd, 0.7057@u_V)
    circuit.V('VB3', 'V_B3', circuit.gnd, 1.0395@u_V)
    circuit.V('VB4', 'V_B4', circuit.gnd, 0.3061@u_V)
