...
N 1280 -390 1280 -300 {
lab=VCMFB}
N -600 -300 -550 -300 {lab=VIT_P1}
N -490 -300 -440 -300 {lab=#net1}
N -340 -300 -290 -300 {lab=#net2}
N -230 -300 -180 -300 {lab=VIT_P2}
N 360 -240 360 -220 {lab=VD5}
N 460 -240 460 -220 {lab=VD6}
N 360 220 360 240 {lab=SUM_P}
N 460 220 460 240 {lab=SUM_N}
N 410 220 410 270 {lab=AVSS}
...
C {devices/lab_wire.sym} 360 230 0 0 {name=p28 sig_type=std_logic lab=SUM_P}
C {devices/lab_wire.sym} 460 230 0 1 {name=p29 sig_type=std_logic lab=SUM_N}
...
C {devices/lab_wire.sym} 360 -230 0 0 {name=p38 sig_type=std_logic lab=VD5}
C {devices/lab_wire.sym} 460 -230 0 1 {name=p39 sig_type=std_logic lab=VD6}
...
C {devices/lab_wire.sym} 410 270 2 1 {name=p47 sig_type=std_logic lab=AVSS}
...
C {devices/ammeter.sym} -520 -300 1 0 {name=V_iT1}
C {devices/ammeter.sym} -260 -300 3 1 {name=V_iT2}
C {devices/ammeter.sym} 360 -270 0 1 {name=V_iX1}
C {devices/ammeter.sym} 460 -270 0 0 {name=V_iX2}
C {devices/ammeter.sym} 360 270 0 1 {name=V_iP1}
C {devices/ammeter.sym} 460 270 0 0 {name=V_iP2}
